...
export function ScoreChip({ value }: { value: number }) {
  return (
    <span className="inline-flex items-center gap-1 rounded-chip px-3 h-7 bg-accent-teal/15 text-accent-teal  text-[12px] font-semibold tracking-[0.4px] no-select">
